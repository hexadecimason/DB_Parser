...
cursor.execute("""CREATE TABLE boxes (
				file_num		text REFERENCES wells(file_num),
				box_num			int,
				fm				text,
				top				text,
				bottom			text,
...
for well in well_list:
	...
	# add boxes
	addBox_query = """INSERT INTO boxes VALUES
					(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);"""


	for bx in well['boxes']:

		addBox_tuple = (well['file'], bx['box #'], bx['fm'], bx['top'],
